...
function Login({onLogin}){
  ...
  return <div className="login-screen">
    <div className="login-card">
      ...
      <small>Secure access · LORD PHONES POS</small>
    </div>
  </div>
}
...
function Reports(){
  ...
  return <section className="content reports-page">
    ...
    <div className="print-report-header"><h1>LORD PHONES AND ACCESSORIES</h1><p>Business Report · {from} to {to}</p></div>
